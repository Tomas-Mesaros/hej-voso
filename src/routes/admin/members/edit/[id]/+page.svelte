<script>
    ...
    async function loadMember() {
        try {
            ...
            if (response.ok) {
                ...
                console.log('Loaded member data:', member);
                formData = {
                ...
                alert('Člen sa nenašiel');
                goto('/admin/members');
            }
        } catch (error) {
            console.error('Error loading member:', error);
            alert('Chyba pri načítaní člena');
            goto('/admin/members');
        } finally {
            isLoading = false;
        }
    ...
    async function submitForm() {
        ...
        try {
            ...
            // Add all form fields except photo (handled separately)
...
<svelte:head>
    <title>Upraviť člena - Admin Panel</title>
    <meta name="robots" content="noindex, nofollow" />
</svelte:head>

{#if isLoggedIn}
    <main class="admin-edit-member">
        <div class="page-header">
            <div class="header-content">
                <div class="title-section">
                    <h1><i class="fas fa-user-edit"></i> Upraviť člena</h1>
                    <p>Upravte informácie o členovi kapely</p>
                </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        <label for="stage_name">Umelecké meno</label>
                                        <input
                                            type="text"
                                            id="stage_name"
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        <label for="join_date">Dátum vstupu do kapely</label>
                                        <input
                                            type="date"
                                            id="join_date"
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="leave_date">Dátum vystúpenia z kapely</label>
                                        <input
                                            type="date"
                                            id="leave_date"
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="photo_file">Nahrať novú fotografiu</label>
                                        <input
                                            type="file"
                                            id="photo_file"
                                            accept="image/*"
                                        ...
                                        {:else if formData.photo}
                                            <div class="current-photo">
                                                <i class="fas fa-image"></i>
                                                Aktuálna fotografia: {formData.photo}
                                            </div>
                                        {/if}
                                    </div>
...
<style>
    /* Použijem rovnaké štýly ako pre add page */
    .admin-edit-member {
        min-height: 100vh;
    ...
    .file-preview i, .current-photo i {
        margin-right: 0.5rem;
    }
